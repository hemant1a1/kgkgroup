    ...
    <section className="bg-white py-24 overflow-x-hidden">
      <div className="flex flex-col md:flex-row items-center md:items-start px-4 md:pl-0 md:pr-7 gap-6">
        ...
        <div className="w-full md:w-[38%]">
          ...
          <motion.p
            className="text-sm lg:text-[15px] leading-[25px] tracking-wide text-black max-w-lg lg:pr-14"
        ...
        {/* Right Image */}
        <motion.div
          className="w-full md:w-[36%] flex justify-center md:justify-start h-[300px] lg:pt-6 lg:ml-[-45px]"
          initial={{ opacity: 0, x: 60 }}
          whileInView={{ opacity: 1, x: 0 }}
